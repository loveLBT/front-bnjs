...
/***/ function(module, exports, __webpack_require__) {
		...
		_createClass(Personal, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: 'personal' },
					personal && _react2.default.createElement(
						'div',
						{ className: 'data_cell' },
						_react2.default.createElement(
							'div',
							{ className: 'contact borderBottom' },
							_react2.default.createElement(_components.Panel, { title: '\u5FAE\u4FE1', text: personal.result.weiXingH, hasBorder: true }),
							_react2.default.createElement(_components.Panel, { title: '\u624B\u673A\u53F7', text: personal.result.phone })
						),
						_react2.default.createElement(
							'div',
							{ className: 'car borderBottom' },
							_react2.default.createElement(_components.Panel, { title: '\u8EAB\u4EFD\u8BC1\u53F7\u7801', text: personal.result.sfzh, hasBorder: true }),
							_react2.default.createElement(_components.Panel, { title: '\u8EAB\u4EFD\u8BC1\u7167\u7247', carImg: personal.result.sfzhZM, carReverseImg: personal.result.sfzhFM, hasCarImg: true })
						)
					)
				);
			}
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Personal);
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("G:\\Gitproject\\front-bnjs\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Personal.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
