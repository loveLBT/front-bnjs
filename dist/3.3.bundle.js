...
/***/ function(module, exports, __webpack_require__) {
	...
	var Register = function (_Component) {
		...
		_createClass(Register, [{
			...
			value: function componentWillMount() {
				...
				var radioUrl = apiUrl + "/WSRegisterData";
			...
			value: function renderRadios() {
				...
				if (!!register) {
					return register.result.map(function (item, i) {
						return _react2.default.createElement(_components.Radio, {
							key: i,
							radioName: 'agentGroup',
							txt: item.name,
							value: item.agentID,
							handleChange: _this2.handleChange.bind(_this2, "AgentID"),
							defaultChecked: item.agentID == _this2.state.AgentID
						});
					});
				}
			}
			...
			value: function handleSubmit() {
				...
				var TrueName = _state.TrueName;
				var Password = _state.Password;
				var WeiXingH = _state.WeiXingH;
				var UpPhone = _state.UpPhone;
				var AgentID = _state.AgentID;

				var registerUrl = apiUrl + '/WSRegisterUser?UserName=' + UserName + '&Password=' + Password + '&TrueName=' + TrueName + '&WeiXingH=' + WeiXingH + '&UpPhone=' + UpPhone + '&AgentID=' + AgentID;
				this.setState({ loading: true });
				_Auth2.default.login(registerUrl, function (res) {
					_this3.setState({ loading: false });
					if (!res.loggedIn) _components.Toast.tip(res.errormsg);else {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'radio_cell flex-ai flex-multiple' },
							this.renderRadios()
						),
						_react2.default.createElement(
							'div',
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							_reactRouter.Link,
							{ className: 'not_user', to: '/login' },
							'\u5DF2\u6709\u8D26\u53F7?\u9A6C\u4E0A\u767B\u5F55'
						)
					),
					this.state.loading && _react2.default.createElement(_components.Loading, { text: '\u6B63\u5728\u6CE8\u518C\uFF0C\u8BF7\u7B49\u5F85' })
				);
			}
		}]);
	...
	exports.default = (0, _reactRouter.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Register));
	module.exports = exports['default'];
