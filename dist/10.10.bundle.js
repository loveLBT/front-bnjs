...
/***/ function(module, exports, __webpack_require__) {
	...
	var BuyProduct = function (_Component) {
		...
		_createClass(BuyProduct, [{
			...
			value: function getProduct() {
				...
				var productUrl = apiUrl + "/WSProductList";
			...
			value: function handleTouchEnd() {
				...
				var price = _state3.price;
				var count = _state3.count;

				var ProductId = items[index].id;
				var priceSum = price * count;
				var submitOrderUrl = apiUrl + "/WSSubmitOrder?productId=" + ProductId + "&count=" + count + "&priceSum=" + priceSum;
				this.setState({
					loading: true
				});
				this.timer = setTimeout(function () {
					actions.fetchPosts("submitorder", submitOrderUrl).then(function (data) {
						_this2.setState({ loading: false });
						if (data.posts.status === "success") {
							_components.Toast.tip("订单提交成功");
							_this2.props.router.push('/myorder');
						} else {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					items[index] && _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							items.map(function (item, i) {
								return _react2.default.createElement('img', { src: hostUrl + item.pic, className: 'slider-item', key: i, alt: '' });
							})
						),
						_react2.default.createElement(
							'div',
					...
					this.state.loading && _react2.default.createElement(_components.Loading, { text: '\u8BA2\u5355\u6B63\u5728\u63D0\u4EA4\uFF0C\u8BF7\u7B49\u5F85' })
				);
			}
		}]);
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("G:\\Gitproject\\front-bnjs\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "BuyProduct.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
