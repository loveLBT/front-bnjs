...
/***/ function(module, exports, __webpack_require__) {
	...
	var ApplyDetail = function (_Component) {
		_inherits(ApplyDetail, _Component);

		function ApplyDetail(props) {
			_classCallCheck(this, ApplyDetail);

			var _this = _possibleConstructorReturn(this, (ApplyDetail.__proto__ || Object.getPrototypeOf(ApplyDetail)).call(this, props));
		...
		_createClass(ApplyDetail, [{
			key: 'componentWillMount',
			value: function componentWillMount() {
				var actions = this.props.actions;

				var applydetailUrl = apiUrl + "/WSMyCustomerRegRequestDetail?userID=" + this.props.params.id;
			...
			value: function handleTouchAgree() {
				...
				var auditingUrl = apiUrl + "/WSMyCustomerRegRequestCheck?userID=" + this.props.params.id + "&isPass=" + 1;
			...
			value: function handleTouchReject() {
				...
				var auditingUrl = apiUrl + "/WSMyCustomerRegRequestCheck?userID=" + this.props.params.id + "&isPass=" + 0;
					...
					!!items && _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(_components.Panel, { title: '\u8EAB\u4EFD\u8BC1\u7167\u7247', carImg: items.sfzhZM, carReverseImg: items.sfzhFM, hasCarImg: true })
							)
						)
					)
				);
	...
	exports.default = (0, _reactRouter.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ApplyDetail));
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("G:\\Gitproject\\front-bnjs\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "ApplyDetail.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
