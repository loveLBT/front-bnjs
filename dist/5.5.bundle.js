	...
	var RealName = function (_Component) {
		...
		_createClass(RealName, [{
			...
			value: function render() {
				...
				var CheckState = !realname ? null : realname.result.CheckState;
				return _react2.default.createElement(
					'div',
					{ className: 'realname', style: { width: "100%", height: "100%" } },
					_react2.default.createElement(_components.UserTop, { isUpload: true, userData: this.state.userData }),
					CheckState == 0 || CheckState == 1 && _react2.default.createElement(
						'div',
						null,
						_react2.default.createElement(
							'div',
							...
							_react2.default.createElement(
								'div',
								{ className: 'car borderBottom' },
								_react2.default.createElement(_components.Panel, { title: '\u8EAB\u4EFD\u8BC1\u7167\u7247', carImg: realname.result.sfzhZMThumb, carReverseImg: realname.result.sfzhFMThumb, hasCarImg: true })
							)
						),
						_react2.default.createElement(
							'div',
					...
					CheckState == -2 || CheckState == -1 && _react2.default.createElement(
						'div',
						{ className: 'data_cell' },
						_react2.default.createElement(
							'div',
							{ className: 'contact borderBottom' },
							_react2.default.createElement(_components.Panel, { title: '\u5FAE\u4FE1\u53F7', input: "你的微信号", maxlength: '20', handleChange: this.handleChange.bind(this, "weiXingH") })
						),
						_react2.default.createElement(
							'div',
							{ className: 'car borderBottom' },
							...
							_react2.default.createElement(_components.Panel, { maxlength: '17', title: '\u8EAB\u4EFD\u8BC1\u53F7', input: "你的身份证号码", type: 'number', handleChange: this.handleChange.bind(this, "sfzh") })
						),
						_react2.default.createElement(
							'div',
							{ className: 'car borderBottom' },
					...
					this.state.loading && _react2.default.createElement(_components.Loading, { text: '\u6B63\u5728\u63D0\u4EA4\u8BF7\u7B49\u5F85' })
				);
			}
		}]);
