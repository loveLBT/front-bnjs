...
/***/ function(module, exports, __webpack_require__) {
	...
	var Empower = function (_Component) {
		_inherits(Empower, _Component);

		function Empower() {
			_classCallCheck(this, Empower);

			return _possibleConstructorReturn(this, (Empower.__proto__ || Object.getPrototypeOf(Empower)).apply(this, arguments));
		}

		_createClass(Empower, [{
			key: 'componentWillMount',
			value: function componentWillMount() {
				var actions = this.props.actions;

				var empowerUrl = apiUrl + "/WSGetAuthorization";
			...
			value: function componentWillUpdate(nextProps, nextState) {
				if (nextProps.empower) {
					if (nextProps.empower.result.error_code === "101") {
						_components.Toast.tip(nextProps.empower.result.message);
					}
				}
			}
		}, {
			...
			value: function render() {
				document.title = "授权";
				var empower = this.props.empower;

				var data = !empower ? null : empower.result;
				return _react2.default.createElement(
					'div',
					{ className: 'empower' },
					!!data && _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'p',
								{ className: 'number carid' },
								data.sfzh
							),
							_react2.default.createElement(
								'p',
								{ className: 'number weixin' },
								data.weiXingH
							),
							_react2.default.createElement(
								'p',
					...
					this.props.isFetching && _react2.default.createElement(_components.Loading, { text: '\u6B63\u5728\u83B7\u53D6\u6388\u6743\u4FE1\u606F\u8BF7\u7B49\u5F85' })
				);
			}
		}]);
	...
	exports.default = (0, _reactRouter.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Empower));
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("G:\\Gitproject\\front-bnjs\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Empower.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
