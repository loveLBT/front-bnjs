...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyRetail = function (_Component) {
		_inherits(MyRetail, _Component);

		function MyRetail() {
			_classCallCheck(this, MyRetail);

			return _possibleConstructorReturn(this, (MyRetail.__proto__ || Object.getPrototypeOf(MyRetail)).apply(this, arguments));
		}

		_createClass(MyRetail, [{
			key: 'componentWillMount',
			value: function componentWillMount() {
				var actions = this.props.actions;

				var myretailUrl = apiUrl + "/WSMyRetailSellOrders?page=1&pageNum=100";
			...
			value: function render() {
				document.title = "我的零售";
				var myretail = this.props.myretail;

				var items = !myretail ? null : myretail.result.orderList;
				return _react2.default.createElement(
					'div',
					{ className: 'myretail' },
					_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							items && items.map(function (item, i) {
								return _react2.default.createElement(_components.OrderItem, { hasFooter: false, key: i, item: item });
							})
						)
					)
				);
	...
	exports.default = (0, _reactRouter.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(MyRetail));
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("G:\\Gitproject\\front-bnjs\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "MyRetail.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
