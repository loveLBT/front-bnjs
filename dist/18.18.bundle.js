...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyAddress = function (_Component) {
		_inherits(MyAddress, _Component);

		function MyAddress(props) {
			_classCallCheck(this, MyAddress);

			var _this = _possibleConstructorReturn(this, (MyAddress.__proto__ || Object.getPrototypeOf(MyAddress)).call(this, props));
		...
		_createClass(MyAddress, [{
			...
			value: function getMyAddress() {
				...
				var myaddressUrl = apiUrl + "/WSGetAddress";
			...
			value: function handleTouchEnd() {
				...
				var regionCode = document.getElementById("value2").value.split(",")[2];
				var _state = this.state;
				var name = _state.name;
				var cellphone = _state.cellphone;
				var address = _state.address;

				var submitaddressUrl = apiUrl + "/WSEditAddress?name=" + name + "&cellphone=" + cellphone + "&code=" + regionCode + "&address=" + address;
				this.setState({
					loading: true
				});
				this.timer = setTimeout(function () {
					actions.fetchPosts("submitaddress", submitaddressUrl).then(function (data) {
						_this2.setState({ loading: false });
						console.log(data);
						if (data.posts.status === "success") {
							_components.Toast.tip("保存成功");
							_this2.props.router.push("/buyproduct");
						} else {
			...
			value: function handleChangeEdit(event) {
				this.setState({
			...
			value: function render() {
				document.title = "我的地址";
				var myaddress = this.props.myaddress;

				console.log(myaddress);
				return _react2.default.createElement(
					'div',
					{ className: 'myaddress' },
					myaddress && _react2.default.createElement(
						'div',
						null,
						_react2.default.createElement(
							'div',
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(_components.Panel, { handleChange: this.handleChange.bind(this, "name"), title: '\u6536\u8D27\u4EBA', hasBorder: true, input: myaddress.result.name }),
								_react2.default.createElement(_components.Panel, { handleChange: this.handleChange.bind(this, "cellphone"), title: '\u624B\u673A\u53F7', input: myaddress.result.cellphone })
							),
							_react2.default.createElement(
								'div',
								{ className: 'select_address borderBottom' },
								_react2.default.createElement(
									'h3',
									{ className: 'fontStyle_163' },
									'\u6240\u5728\u5730\u533A'
								),
								_react2.default.createElement(_components.LArea, { regionCode: myaddress.result.regionCode, input: myaddress.result.regionName }),
								_react2.default.createElement(
									'span',
									{ className: 'fontStyle_159' },
									'\u8BF7\u9009\u62E9',
									' ',
									' >'
								)
							...
							_react2.default.createElement(
								'div',
								{ className: 'detail_address borderBottom' },
								_react2.default.createElement('textarea', { className: 'fontStyle_143', placeholder: myaddress.result.address, onChange: this.handleChangeEdit.bind(this) })
							),
							_react2.default.createElement(
								'div',
	...
	exports.default = (0, _reactRouter.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(MyAddress));
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("G:\\Gitproject\\front-bnjs\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "MyAddress.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
