...
/***/ function(module, exports, __webpack_require__) {
	...
	var OrderDetail = function (_Component) {
		...
		_createClass(OrderDetail, [{
			...
			key: 'getUserOrderDetail',
			value: function getUserOrderDetail() {
				var actions = this.props.actions;

				var userOrderDetailUrl = apiUrl + "/WSCustomerOrderDetail?orderId=" + this.props.params.id;
			...
			value: function render() {
				document.title = "订单详情";
				var userorderdetail = this.props.userorderdetail;

				return _react2.default.createElement(
					'div',
					{ className: 'orderdetail' },
					userorderdetail && _react2.default.createElement(
						'div',
						null,
						_react2.default.createElement(
							'div',
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'p',
									{ className: 'txt' },
									userorderdetail.result.ShipAddressRegion
								)
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: 'body' },
								_react2.default.createElement(_components.OrderItem, { style: { marginBottom: 0 }, item: userorderdetail.result })
							)
						),
						_react2.default.createElement(
							'div',
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'p',
									{ className: 'txt' },
									userorderdetail.result.orderCode
								)
							)
						)
					)
	...
	var mapStateToProps = function mapStateToProps(state) {
		...
		var userorderdetail = posts.userorderdetail;
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("G:\\Gitproject\\front-bnjs\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "UserOrderDetail.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
