...
/***/ function(module, exports, __webpack_require__) {
	...
	var BuyProduct = function (_Component) {
		...
		_createClass(BuyProduct, [{
			...
			key: 'changePrice',
			value: function changePrice(count) {
				var _state3 = this.state;
				var index = _state3.index;
				var items = _state3.items;

				var agentLevels = items[index].agentLevels;
				var i = 0;
			...
			value: function handleTouchEnd() {
				...
				if (count < items[index].minConsumption) {
					_components.Toast.tip("该商品的最低购买数量为" + items[index].minConsumption + "件");
					return false;
				}
				this.setState({
					loading: true
			...
			value: function render() {
				...
				var items = _state5.items;
				var index = _state5.index;
				var price = _state5.price;
					...
					items[index] && _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement('input', { onBlur: this.handleBlur.bind(this), onFocus: this.handleFocus.bind(this), ref: 'count', onChange: this.handleChangeCount.bind(this), type: 'number', defaultValue: count }),
								_react2.default.createElement(
									'span',
