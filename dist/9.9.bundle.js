...
/***/ function(module, exports, __webpack_require__) {
	...
	var Popup = function (_Component) {
		...
		_createClass(Popup, [{
			key: 'handlePopupSend',
			value: function handlePopupSend() {
				var _this2 = this;
				...
				var ordernumber = this.refs.ordernumber.value;
				var sendOederUrl = apiUrl + "/WSCustomerOrderShip?orderId=" + orderId + "&shipOrderNumber=" + ordernumber;
				this.props.setLoading(true, "正在发货，请等待");
				this.props.closePopup();
				this.timer = setTimeout(function () {
					actions.fetchPosts("sendorder", sendOederUrl).then(function (data) {
						if (data.posts.status === "success") {
							_this2.props.getUserOrder();
							_components.Toast.tip(data.posts.result);
						} else {
							_components.Toast.tip(data.posts.result.message);
						}
						_this2.props.setLoading(false, null);
					});
				}, 2000);
			}
		}, {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'content' },
							_react2.default.createElement('input', { ref: 'ordernumber', type: 'text' })
						),
						_react2.default.createElement(
							'div',
	...
	var UserOrder = function (_Component2) {
		_inherits(UserOrder, _Component2);

		function UserOrder(props) {
			_classCallCheck(this, UserOrder);

			var _this3 = _possibleConstructorReturn(this, (UserOrder.__proto__ || Object.getPrototypeOf(UserOrder)).call(this, props));
		...
		_createClass(UserOrder, [{
			...
			value: function getUserOrder() {
				...
				var userOrderUrl = apiUrl + "/WSCustomerOrderList?page=" + page + "&pageNum=" + pageNum;
			...
			key: 'setLoading',
			value: function setLoading(state, txt) {
				this.setState({
					loadingObj: {
						loading: state,
						text: txt
			...
			value: function handleCancel(id) {
				...
				var userOrderCancelUrl = apiUrl + "/WSCustomerOrderCancel?orderId=" + id;
				this.setState({
					loadingObj: { loading: true, text: "订单正在取消，请等待" }
				});
				this.timer = setTimeout(function () {
					actions.fetchPosts("userordercancel", userOrderCancelUrl).then(function (data) {
						_this4.getUserOrder();
						_this4.setState({ loadingObj: { loading: false, text: null } });
						_components.Toast.tip(data.posts.result);
					});
				}, 2000);
			}
			...
			value: function render() {
				...
				document.title = "用户订单";
				var userorder = this.props.userorder;

				var btnCount = [];
				return _react2.default.createElement(
					'div',
					{ className: 'userorder' },
					userorder && _react2.default.createElement(
						'div',
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							userorder && userorder.result.orderList.map(function (item, i) {
								if (item.state == 0) {
									btnCount = [{ btnText: "发货", btnFn: _this5.openPopup.bind(_this5, item.orderId) }, { btnText: "取消", btnFn: _this5.handleCancel.bind(_this5, item.orderId) }, { btnText: "详情", btnFn: _this5.handleDetail.bind(_this5, item.orderId) }];
								} else {
									btnCount = [{ btnText: "详情", btnFn: _this5.handleDetail.bind(_this5, item.orderId) }];
								}
								return _react2.default.createElement(_components.OrderItem, { linkTo: /userorder/ + item.orderId, item: item, key: i, btnText: '\u8BE6\u60C5', btnCount: btnCount });
							})
						)
					),
					this.state.loadingObj.loading && _react2.default.createElement(_components.Loading, { text: this.state.loadingObj.text }),
					this.state.popupObj.popup && _react2.default.createElement(Popup, {
	...
	exports.default = (0, _reactRouter.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(UserOrder));
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("G:\\Gitproject\\front-bnjs\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "userorder.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
