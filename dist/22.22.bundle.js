...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyTeaItem = function (_Component) {
		_inherits(MyTeaItem, _Component);

		function MyTeaItem() {
			_classCallCheck(this, MyTeaItem);

			return _possibleConstructorReturn(this, (MyTeaItem.__proto__ || Object.getPrototypeOf(MyTeaItem)).apply(this, arguments));
		}

		_createClass(MyTeaItem, [{
			key: 'render',
			value: function render() {
				var item = this.props.item;
				...
				return _react2.default.createElement(
					'div',
					{ className: 'myteaitem borderBottom' },
					_react2.default.createElement(
						'div',
						{ className: 'flex-ai borderBottom', style: { padding: "0.32rem 0" } },
						_react2.default.createElement(
							'div',
							{ className: 'avator_cell' },
							_react2.default.createElement(_components.Avator, { avatorUrl: item.gravatarThumb })
						),
						_react2.default.createElement(
							'div',
							{ className: 'msg_cell flex-1 flex-column-between' },
					...
					_react2.default.createElement(
						'div',
						{ className: 'kinds_cell flex-ai' },
						_react2.default.createElement(
							'p',
							{ className: 'fontStyle_126' },
							'\u62FF\u8D27\uFF1A\u603B\u8BA1',
							_react2.default.createElement(
								'span',
								{ className: 'red' },
	...
	var MyTea = function (_Component2) {
		_inherits(MyTea, _Component2);

		function MyTea() {
			_classCallCheck(this, MyTea);

			return _possibleConstructorReturn(this, (MyTea.__proto__ || Object.getPrototypeOf(MyTea)).apply(this, arguments));
		}
		...
		_createClass(MyTea, [{
			...
			key: 'getMyTea',
			value: function getMyTea() {
				var actions = this.props.actions;

				var myteasUrl = apiUrl + "/WSMyCustomerList?page=1&pageNum=100";
			...
			value: function render() {
				document.title = "我的团队";
				var mytea = this.props.mytea;

				console.log(mytea);
				return _react2.default.createElement(
					'div',
					{ className: 'mytea' },
					mytea && _react2.default.createElement(
						'div',
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							mytea && mytea.result.customerList.map(function (item, i) {
								return _react2.default.createElement(MyTeaItem, { key: i, item: item });
							})
						)
					)
				);
	...
	exports.default = (0, _reactRouter.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(MyTea));
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("G:\\Gitproject\\front-bnjs\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "MyTea.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
