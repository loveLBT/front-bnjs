...
/***/ function(module, exports, __webpack_require__) {
	...
	var Apply = function (_Component) {
		...
		_createClass(Apply, [{
			...
			value: function componentWillMount() {
				...
				var registerapplyUrl = apiUrl + "/WSMyCustomerRegRequests?page=" + page + "&pageNum=" + pageNum;
			...
			value: function handleChangeTab() {
				...
				var upapplyUrl = apiUrl + "/WSUpGradeRequests?page=" + page + "&pageNum=" + pageNum;
			...
			key: 'handleLinkTo',
			value: function handleLinkTo(url) {
				this.props.router.push(url);
			}
		}, {
			key: 'renderItem1',
			value: function renderItem1() {
				var _this2 = this;

				var registeitems = this.state.registeitems;

				return _react2.default.createElement(
					'div',
					{ className: 'item' },
					!!registeitems && registeitems.map(function (item, i) {
						return _react2.default.createElement(_components.ApplyItem, { handleLinkTo: _this2.handleLinkTo.bind(_this2, "/apply/" + item.userID), key: i, item: item });
					})
				);
			}
		}, {
			...
			value: function renderItem2() {
				...
				var upitems = this.state.upitems;

				return _react2.default.createElement(
					'div',
					{ className: 'item' },
					!!upitems && upitems.map(function (item, i) {
						return _react2.default.createElement(_components.ApplyItem, { handleLinkTo: _this3.handleLinkTo.bind(_this3, "/upapply/" + item.requestID), key: i, item: item });
					})
				);
			}
		}, {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: 'apply' },
					_react2.default.createElement(_components.SliderTab, {
						handleChangeTab: this.handleChangeTab.bind(this),
						navArry: [{ text: "注册审核申请", item: this.renderItem1() }, { text: "升级申请", item: this.renderItem2() }]
					})
				);
			}
		}]);
	...
	exports.default = (0, _reactRouter.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Apply));
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("G:\\Gitproject\\front-bnjs\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Apply.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
