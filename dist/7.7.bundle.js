...
/***/ function(module, exports, __webpack_require__) {
	...
	var Menu = function (_Component) {
		...
		_createClass(Menu, [{
			...
			value: function render() {
				var _props = this.props;
				var hasBorder = _props.hasBorder;
				var iconCn = _props.iconCn;
				var menuName = _props.menuName;
				var linkTo = _props.linkTo;
				var count = this.state.count;

				return _react2.default.createElement(
					_reactRouter.Link,
					{ to: linkTo, className: (0, _classnames2.default)("flex-1 flex-direction-center", { borderRight: hasBorder }) },
					_react2.default.createElement(
						'div',
						null,
						_react2.default.createElement('i', { className: (0, _classnames2.default)("icon", iconCn), style: { marginTop: "0.22rem" } }),
						count && _react2.default.createElement(_components.Badge, { count: count, s: { position: "absolute" }, cn: 'redBage' })
					),
					_react2.default.createElement(
						'p',
						{ className: 'fontStyle_146' },
						menuName
					)
				);
			}
	...
	var Home = function (_Component2) {
		...
		_createClass(Home, [{
			...
			value: function getHome() {
				...
				var homeUrl = apiUrl + "/WSAppIndexState";
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					home && _react2.default.createElement(
						'div',
						{ className: 'order_cell', style: { paddingTop: "3px", marginTop: "-2px" }, onTouchStart: this.handleTouchStart.bind(this) },
						_react2.default.createElement(
							'ul',
							null,
							_react2.default.createElement(
								...
								_react2.default.createElement(
									_reactRouter.Link,
									{ to: '/myorder' },
									_react2.default.createElement('i', { className: 'icon icon_myorder' }),
									_react2.default.createElement(
										'span',
										{ ref: 'badgePosition1' },
										'\u6211\u7684\u8BA2\u5355'
								...
								_react2.default.createElement(_components.Badge, {
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									_reactRouter.Link,
									{ to: '/userorder' },
									_react2.default.createElement('i', { className: 'icon icon_userorder' }),
									_react2.default.createElement(
										'span',
										null,
										'\u5BA2\u6237\u8BA2\u5355'
					...
					home && _react2.default.createElement(
						'div',
						{ className: 'menu_cell flex-column', onTouchStart: this.handleTouchStart.bind(this) },
						_react2.default.createElement(
							'div',
							{ className: 'item borderBottom flex-1 flex' },
							_react2.default.createElement(Menu, { linkTo: '/mytea', hasBorder: true, iconCn: 'icon_mytea', menuName: '\u6211\u7684\u56E2\u961F' }),
							_react2.default.createElement(Menu, { linkTo: '/apply', hasBorder: true, iconCn: 'icon_apply', menuName: '\u7533\u8BF7\u5217\u8868', count: home.result.userRegNum }),
							_react2.default.createElement(Menu, { linkTo: '/myaccount', iconCn: 'icon_user', menuName: '\u6211\u7684\u8D26\u6237', count: home.result.productUpgradeNum })
						),
						_react2.default.createElement(
							'div',
							{ className: 'item borderBottom flex-1 flex' },
							_react2.default.createElement(Menu, { linkTo: '/myretail', hasBorder: true, iconCn: 'icon_retial', menuName: '\u6211\u7684\u96F6\u552E' }),
							_react2.default.createElement(Menu, { linkTo: '/buyproduct', hasBorder: true, iconCn: 'icon_stock', menuName: '\u6211\u8981\u8FDB\u8D27' }),
							_react2.default.createElement(Menu, { linkTo: '/backproduct', iconCn: 'icon_back', menuName: '\u9000\u8D27\u7533\u8BF7' })
						),
						_react2.default.createElement(
							'div',
							{ className: 'item borderBottom flex-1 flex' },
							_react2.default.createElement(Menu, { linkTo: '/myaddress', hasBorder: true, iconCn: 'icon_address', menuName: '\u6211\u7684\u5730\u5740' }),
							_react2.default.createElement(Menu, { linkTo: '/realname', hasBorder: true, iconCn: 'icon_realname', menuName: '\u5B9E\u540D\u8BA4\u8BC1' }),
							_react2.default.createElement(Menu, { linkTo: '/editpwd', iconCn: 'icon_pwd', menuName: '\u4FEE\u6539\u5BC6\u7801' })
						)
					)
				);
			}
