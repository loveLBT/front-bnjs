...
/***/ function(module, exports, __webpack_require__) {
	...
	var BackProduct = function (_Component) {
		...
		_createClass(BackProduct, [{
			...
			key: 'getBackProduct',
			value: function getBackProduct() {
				var actions = this.props.actions;

				var backproductUrl = apiUrl + "/WSMyAccountData";
			...
			value: function render() {
				document.title = "退货";
				var backproduct = this.props.backproduct;

				console.log(backproduct);
				return _react2.default.createElement(
					'div',
					{ className: 'backproduct' },
					backproduct && _react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								backproduct.result.AllSumPurchase,
								'\u76D2'
							),
							'\u5F53\u524D\u5E93\u5B58\uFF1A',
							_react2.default.createElement(
	...
	var mapStateToProps = function mapStateToProps(state) {
		...
		var backproduct = posts.backproduct;
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(BackProduct);
	module.exports = exports['default'];
