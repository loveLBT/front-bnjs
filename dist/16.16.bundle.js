...
/***/ function(module, exports, __webpack_require__) {
	...
	var UpApplyDetail = function (_Component) {
		_inherits(UpApplyDetail, _Component);

		function UpApplyDetail(props) {
			_classCallCheck(this, UpApplyDetail);

			var _this = _possibleConstructorReturn(this, (UpApplyDetail.__proto__ || Object.getPrototypeOf(UpApplyDetail)).call(this, props));
		...
		_createClass(UpApplyDetail, [{
			key: 'componentWillMount',
			value: function componentWillMount() {
				var actions = this.props.actions;

				var upapplydetailUrl = apiUrl + "/WSUpGradeRequestDetail?requestID=" + this.props.params.id;
			...
			key: 'handleTouchAgree',
			value: function handleTouchAgree() {
				var _this2 = this;

				var actions = this.props.actions;

				var auditingUrl = apiUrl + "/WSUpGradeRequestCheck?requestID=" + this.props.params.id + "&isPass=" + 1;
				actions.fetchPosts("agreedata", auditingUrl).then(function (data) {
					_components.Toast.tip(data.posts.result.message);
					_this2.props.router.push("apply");
				});
			}
		}, {
			key: 'handleTouchReject',
			value: function handleTouchReject() {
				var _this3 = this;

				var actions = this.props.actions;

				var auditingUrl = apiUrl + "/WSUpGradeRequestCheck?requestID=" + this.props.params.id + "&isPass=" + 0;
				actions.fetchPosts("rejectdata", auditingUrl).then(function (data) {
					_components.Toast.tip(data.posts.result.message);
					_this3.props.router.push("apply");
				});
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: 'applydetail' },
					!!items && _react2.default.createElement(
						'div',
						null,
						_react2.default.createElement(_components.UserTop, {
							className: 'writeBg',
							hasStateCell: true,
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(_components.Panel, { title: '\u5FAE\u4FE1', text: items.weiXingH })
							),
							_react2.default.createElement(
								'div',
								{ className: 'car borderBottom' },
								_react2.default.createElement(_components.Panel, { title: '\u8EAB\u4EFD\u8BC1\u53F7\u7801', text: items.sfzh })
							),
							_react2.default.createElement(
								'div',
								{ className: 'car borderBottom' },
								_react2.default.createElement(_components.Panel, { title: '\u7533\u8BF7\u7B49\u7EA7\u540D\u79F0', text: items.agentLevelName })
							),
							_react2.default.createElement(
								'div',
								{ className: 'car borderBottom' },
								_react2.default.createElement(_components.Panel, { title: '\u7533\u8BF7\u5F53\u65F6\u7D2F\u8BA1', text: items.remark })
							)
						)
					)
				);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(UpApplyDetail);
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("G:\\Gitproject\\front-bnjs\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "UpApplyDetail.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
