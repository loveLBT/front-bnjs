	...
	var Login = function (_Component) {
		...
		_createClass(Login, [{
			...
			value: function handleSubmit() {
				...
				var loginUrl = apiUrl + "/wslogin?username=" + username + "&password=" + password;
				_Auth2.default.login(loginUrl, function (res) {
					_this2.setState({ loading: false });
					if (!res.loggedIn) _components.Toast.tip(res.errormsg);
			...
			key: 'requireRememberPwd',
			value: function requireRememberPwd(user, pwd) {
				var rememberPwd = this.state.rememberPwd;
			...
			value: function render() {
				...
				var rememberPwd = _state2.rememberPwd;
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							_reactRouter.Link,
							{ className: 'not_user', to: '/register' },
							'\u6CA1\u6709\u8D26\u53F7\u7ACB\u5373?\u7ACB\u5373\u6CE8\u518C'
						)
					),
					this.state.loading && _react2.default.createElement(_components.Loading, { text: '\u6B63\u5728\u767B\u5F55\uFF0C\u8BF7\u7B49\u5F85' })
				);
			}
		}]);
