...
/***/ function(module, exports, __webpack_require__) {
	...
	var Upgrade = function (_Component) {
		...
		function Upgrade(props) {
			...
			var _this = _possibleConstructorReturn(this, (Upgrade.__proto__ || Object.getPrototypeOf(Upgrade)).call(this, props));
		...
		_createClass(Upgrade, [{
			...
			value: function getUpgrade() {
				...
				var upgradeUrl = apiUrl + "/WSMyProductUpgrades";
					...
					items && _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							items.map(function (item, i) {
								return _react2.default.createElement('img', { src: hostUrl + item.thumbnailUrl, className: 'slider-item', key: i, alt: '' });
							})
						),
						_react2.default.createElement(
							'div',
							{ className: 'nature flex-ai' },
							_react2.default.createElement(
								'div',
								{ className: 'fontStyle_143' },
								'\u5F53\u524D\u7B49\u7EA7\uFF1A',
						...
						_react2.default.createElement(
							'div',
							{ className: 'btn_big_cell' },
							_react2.default.createElement(_components.Button, {
								btnCn: (0, _classnames2.default)("btn_big btn_radius", { btn_danger: items[index].upGrade == 1 }, { btn_disabled: items[index].upGrade != 1 }),
								text: '\u5347\u7EA7',
								handleTouchEnd: this.handleTouchEnd.bind(this)
							})
						)
					),
					this.state.loading && _react2.default.createElement(_components.Loading, { text: '\u6B63\u5728\u5347\u7EA7\u8BF7\u7B49\u5F85' })
				);
			}
		}]);
	...
	exports.default = (0, _reactRouter.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Upgrade));
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("G:\\Gitproject\\front-bnjs\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Upgrade.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
