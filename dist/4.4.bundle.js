	...
	var MyAddress = function (_Component) {
		...
		_createClass(MyAddress, [{
			...
			value: function handleTouchEnd() {
				...
				var _state$myaddress = this.state.myaddress;
				var name = _state$myaddress.name;
				var cellphone = _state$myaddress.cellphone;
				var address = _state$myaddress.address;

				var nameReg = /^[\u4E00-\u9FA5]{2,5}$/;
				var telReg = /^1[34578]\d{9}$/;
				if (name == "") {
					_components.Toast.tip("收货人姓名不能为空");
					return false;
				}
				if (!nameReg.test(name)) {
					_components.Toast.tip("收货人名字由2-5个汉字组成");
					return false;
				}
				if (cellphone == "") {
					_components.Toast.tip("收货人手机号不能为空");
					return false;
				}
				if (!telReg.test(cellphone)) {
					_components.Toast.tip("收货人手机号格式不正确");
					return false;
				}
				if (regionCode == "") {
					_components.Toast.tip("所在地区不能为空");
					return false;
				}
				if (address == "") {
					_components.Toast.tip("请填写详细地址");
					return false;
				}
			...
			key: 'componentWillUnmount',
			value: function componentWillUnmount() {
				if (document.getElementsByClassName("gearArea")[0]) document.body.removeChild(document.getElementsByClassName("gearArea")[0]);
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: 'myaddress', style: { width: "100%", height: "100%" } },
					...
					myaddress && _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(_components.Panel, { handleChange: this.handleChange.bind(this, "name"), title: '\u6536\u8D27\u4EBA', hasBorder: true, input: '\u6536\u8D27\u4EBA\u59D3\u540D', defaultValue: myaddress.name, maxlength: '20' }),
							_react2.default.createElement(_components.Panel, { handleChange: this.handleChange.bind(this, "cellphone"), title: '\u624B\u673A\u53F7', type: 'tel', input: '\u6536\u8D27\u4EBA\u624B\u673A\u53F7', defaultValue: myaddress.cellphone, maxlength: '11' })
						),
						_react2.default.createElement(
							'div',
							...
							_react2.default.createElement(_components.LArea, { regionCode: myaddress.regionCode, input: myaddress.regionName }),
							_react2.default.createElement(
								'span',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement('textarea', { className: 'fontStyle_143', defaultValue: myaddress.address, placeholder: '\u8BE6\u7EC6\u5730\u5740', onChange: this.handleChangeEdit.bind(this) })
						),
						_react2.default.createElement(
							'div',
					...
					this.state.loading && _react2.default.createElement(_components.Loading, { text: '\u6B63\u5728\u4FDD\u5B58\uFF0C\u8BF7\u7B49\u5F85\u3002\u3002\u3002' })
				);
			}
		}]);
