...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditPwd = function (_Component) {
		_inherits(EditPwd, _Component);

		function EditPwd(props) {
			_classCallCheck(this, EditPwd);

			var _this = _possibleConstructorReturn(this, (EditPwd.__proto__ || Object.getPrototypeOf(EditPwd)).call(this, props));
		...
		_createClass(EditPwd, [{
			...
			value: function handleTouchEnd() {
				...
				if (!oldpwd || !newpwd || !confirmpwd) {
					_components.Toast.tip("请输入");
					return false;
				} else if (newpwd !== confirmpwd) {
					_components.Toast.tip("两次输入的密码不一致");
					return false;
				} else {
					(function () {
						var actions = _this2.props.actions;

						var editpwdUrl = apiUrl + "/WSModifyPsd?oldPassWord=" + oldpwd + "&newPassWord=" + newpwd;
						_this2.setState({
							loading: true
						});
						_this2.timer = setTimeout(function () {
							actions.fetchPosts("editpwd", editpwdUrl).then(function (data) {
								_this2.setState({ loading: false });
								if (data.posts.status === "success") {
									_components.Toast.tip("密码修改成功");
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					this.state.loading && _react2.default.createElement(_components.Loading, { text: '\u6B63\u5728\u4FEE\u6539\uFF0C\u8BF7\u7B49\u5F85' })
				);
			}
		}]);
	...
	exports.default = (0, _reactRouter.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(EditPwd));
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("G:\\Gitproject\\front-bnjs\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "EditPwd.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
