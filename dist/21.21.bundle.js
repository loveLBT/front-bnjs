...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyAccount = function (_Component) {
		...
		_createClass(MyAccount, [{
			...
			value: function componentWillMount() {
				...
				var myaccountdataUrl = apiUrl + "/WSMyAccountData";
				var cargorecordUrl = apiUrl + "/WSMyBuyOrders?page=1&pageNum=100";
			...
			value: function renderItem1() {
				var cargorecord = this.props.cargorecord;
			...
			value: function handleChangeTab() {
				...
				var shipmentrecordUrl = apiUrl + "/WSMySellOrders?page=1&pageNum=100";
			...
			value: function render() {
				document.title = "我的账户";
				var myaccountdata = !this.props.myaccountdata ? null : this.props.myaccountdata.result;
				return _react2.default.createElement(
					'div',
					{ className: 'myaccount' },
					!!myaccountdata && _react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								myaccountdata.AllSumPurchase
							),
							'\u5F53\u524D\u5E93\u5B58\uFF1A',
							_react2.default.createElement(
								'span',
								{ className: 'red' },
								myaccountdata.AllStock,
								'\u76D2'
							)
						)
					),
					...
					_react2.default.createElement(_components.SliderTab, {
						...
						navArry: [{ text: "拿货记录", item: this.renderItem1() }, { text: "出货记录", item: this.renderItem2() }]
					})
				);
			}
		}]);
	...
	var mapStateToProps = function mapStateToProps(state) {
		...
		var myaccountdata = posts.myaccountdata;
		var cargorecord = posts.cargorecord;
		var shipmentrecord = posts.shipmentrecord;
	...
	exports.default = (0, _reactRouter.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(MyAccount));
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("G:\\Gitproject\\front-bnjs\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "MyAccount.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
