...
/***/ function(module, exports, __webpack_require__) {
	...
	var _App2 = __webpack_require__(264);
	...
	var _TabBar2 = __webpack_require__(269);

	var _TabBar3 = _interopRequireDefault(_TabBar2);

	var _UserTop2 = __webpack_require__(277);

	var _UserTop3 = _interopRequireDefault(_UserTop2);

	var _Badge2 = __webpack_require__(286);

	var _Badge3 = _interopRequireDefault(_Badge2);

	var _Input2 = __webpack_require__(294);

	var _Input3 = _interopRequireDefault(_Input2);

	var _Radio2 = __webpack_require__(297);

	var _Radio3 = _interopRequireDefault(_Radio2);

	var _Button2 = __webpack_require__(289);

	var _Button3 = _interopRequireDefault(_Button2);

	var _OrderItem2 = __webpack_require__(300);

	var _OrderItem3 = _interopRequireDefault(_OrderItem2);

	var _Scroll2 = __webpack_require__(303);

	var _Scroll3 = _interopRequireDefault(_Scroll2);

	var _ApplyItem2 = __webpack_require__(307);

	var _ApplyItem3 = _interopRequireDefault(_ApplyItem2);

	var _Panel2 = __webpack_require__(310);

	var _Panel3 = _interopRequireDefault(_Panel2);

	var _Toast2 = __webpack_require__(281);

	var _Toast3 = _interopRequireDefault(_Toast2);

	var _Loading2 = __webpack_require__(319);

	var _Loading3 = _interopRequireDefault(_Loading2);

	var _ProductItem2 = __webpack_require__(322);

	var _ProductItem3 = _interopRequireDefault(_ProductItem2);

	var _SliderTab2 = __webpack_require__(327);

	var _SliderTab3 = _interopRequireDefault(_SliderTab2);

	var _Avator2 = __webpack_require__(279);

	var _Avator3 = _interopRequireDefault(_Avator2);

	var _LArea2 = __webpack_require__(330);
		...
		_createClass(TabBar, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'tabbar flex-center', onTouchStart: this.handleTouchStart.bind(this) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Avator = __webpack_require__(279);
		...
		_createClass(Input, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement('label', { className: iconName, htmlFor: id }),
					_react2.default.createElement('input', { defaultValue: defaultValue, onChange: this.onTextChange.bind(this), className: (0, _classnames2.default)("flex-1", { borderBottom: hasChildBorder }), id: id, type: type, placeholder: placeholder })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactIscroll = __webpack_require__(304);

	var _reactIscroll2 = _interopRequireDefault(_reactIscroll);

	var _iscroll = __webpack_require__(306);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV != "production") {
	  var propTypesMaker = __webpack_require__(305).default;
	...
	var Panel = function (_Component) {
		...
		_createClass(Panel, [{
					...
					return _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement('input', { onChange: this.handleUploadFom1.bind(this), type: 'file', name: 'file' })
							)
						),
						_react2.default.createElement(
							'div',
							...
							_react2.default.createElement(
								...
								_react2.default.createElement('input', { onChange: this.handleUploadFom2.bind(this), type: 'file', name: 'file' })
							)
						)
					);
				}
			...
			value: function handleUploadFom1() {
				...
				var uploadUrl = hostUrl + "/AD/WSsfzPhotoUpdate";
				var formdata = new FormData(this.refs.form1);
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					input && _react2.default.createElement('input', { onChange: this.handleChange.bind(this), className: 'fontStyle_143', type: 'text', placeholder: input }),
					this.renderCarImg(),
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{
							className: (0, _classnames2.default)('group flex flex-1', { transition: isTransition }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LAreaData = __webpack_require__(332);
		...
		_createClass(LArea, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement('input', { className: 'fontStyle_143', id: 'demo2', type: 'text', readOnly: true, placeholder: this.props.input }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RealName = function (_Component) {
		_inherits(RealName, _Component);

		function RealName(props) {
			_classCallCheck(this, RealName);

			var _this = _possibleConstructorReturn(this, (RealName.__proto__ || Object.getPrototypeOf(RealName)).call(this, props));
		...
		_createClass(RealName, [{
			...
			value: function getRealname() {
				...
				var personalUrl = apiUrl + "/WSMyRegDetail";
			...
			value: function handleTouchEnd() {
				...
				var _props = this.props;
				var weiXingH = _props.weiXingH;
				var trueName = _props.trueName;
				var sfzh = _props.sfzh;
				var actions = this.props.actions;

				var realnameUrl = apiUrl + "/WSRealNameAuthentication?weiXingH=" + weiXingH + "&trueName=" + trueName + "&sfzh=" + sfzh;
				actions.fetchPosts("realname", realnameUrl).then(function (data) {
					console.log(data);
					if (data.posts.status === "success") {
						_this2.props.router.push("/");
						_components.Toast.tip(data.posts.result);
					} else {
						_components.Toast.tip(data.posts.result);
					}
				});
			...
			value: function render() {
				...
				var haveChecked = !realname ? null : realname.result.haveChecked;
				return _react2.default.createElement(
					'div',
					{ className: 'realname' },
					haveChecked && _react2.default.createElement(
						'div',
						null,
						_react2.default.createElement(
							'div',
							...
							_react2.default.createElement(
								'div',
								{ className: 'contact borderBottom' },
								_react2.default.createElement(_components.Panel, { title: '\u5FAE\u4FE1\u53F7', text: 'realname.result.weiXingH' })
							),
							_react2.default.createElement(
								'div',
								{ className: 'car borderBottom' },
								_react2.default.createElement(_components.Panel, { title: '\u771F\u5B9E\u59D3\u540D', hasBorder: true, text: realname.result.trueName }),
								_react2.default.createElement(_components.Panel, { title: '\u8EAB\u4EFD\u8BC1\u53F7', text: realname.result.sfzh })
							),
							_react2.default.createElement(
								'div',
								{ className: 'car borderBottom' },
								_react2.default.createElement(_components.Panel, { title: '\u8EAB\u4EFD\u8BC1\u7167\u7247', carImg: realname.result.sfzhZM, carReverseImg: realname.result.sfzhFM, hasCarImg: true })
							)
						),
						_react2.default.createElement(
							'div',
							{ className: 'btn_big_cell', style: { marginTop: "0.32rem" } },
					...
					haveChecked == false && _react2.default.createElement(
						'div',
						null,
						_react2.default.createElement(
							'div',
							...
							_react2.default.createElement(
								'div',
								{ className: 'contact borderBottom' },
								_react2.default.createElement(_components.Panel, { title: '\u5FAE\u4FE1\u53F7', input: '\u4F60\u7684\u5FAE\u4FE1\u53F7', handleChange: this.handleChange.bind(this, "weiXingH") })
							),
							_react2.default.createElement(
								'div',
								{ className: 'car borderBottom' },
								_react2.default.createElement(_components.Panel, { title: '\u771F\u5B9E\u59D3\u540D', hasBorder: true, input: '\u4F60\u7684\u771F\u5B9E\u59D3\u540D', handleChange: this.handleChange.bind(this, "trueName") }),
								_react2.default.createElement(_components.Panel, { title: '\u8EAB\u4EFD\u8BC1\u53F7', input: '\u4F60\u7684\u8EAB\u4EFD\u8BC1\u53F7\u7801', handleChange: this.handleChange.bind(this, "sfzh") })
							),
							_react2.default.createElement(
								'div',
								{ className: 'car borderBottom' },
								_react2.default.createElement(_components.Panel, { title: '\u8EAB\u4EFD\u8BC1\u7167\u7247', UploadImg: true })
							)
						),
						_react2.default.createElement(
							'div',
	...
	exports.default = (0, _reactRouter.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(RealName));
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("G:\\Gitproject\\front-bnjs\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "RealName.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
