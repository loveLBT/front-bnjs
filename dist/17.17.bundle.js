...
/***/ function(module, exports, __webpack_require__) {
	...
	var ApplyDetail = function (_Component) {
		...
		function ApplyDetail() {
			...
			return _possibleConstructorReturn(this, (ApplyDetail.__proto__ || Object.getPrototypeOf(ApplyDetail)).apply(this, arguments));
		}
		...
		_createClass(ApplyDetail, [{
			...
			value: function render() {
				document.title = "申请详情";
				var applydetail = this.props.applydetail;

				return _react2.default.createElement(
					'div',
					{ className: 'applydetail', style: { position: "relative", height: "100%", width: "100%" } },
					applydetail && _react2.default.createElement(
						'div',
						null,
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(_components.Panel, { title: '\u5FAE\u4FE1\u53F7', text: applydetail.result.weiXingH, hasBorder: true })
							),
							_react2.default.createElement(
								'div',
								{ className: 'car borderBottom' },
								_react2.default.createElement(_components.Panel, { title: '\u8EAB\u4EFD\u8BC1\u53F7\u7801', text: applydetail.result.sfzh }),
								_react2.default.createElement(_components.Panel, { title: '\u8EAB\u4EFD\u8BC1\u7167\u7247', carImg: applydetail.result.sfzhZMThumb, carReverseImg: applydetail.result.sfzhFMThumb, hasCarImg: true })
							)
						)
					)
				);
	...
	var mapStateToProps = function mapStateToProps(state) {
		...
		var applydetail = posts.applydetail;
