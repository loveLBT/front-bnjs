...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dashboard = function (_Component) {
		...
		function Dashboard(props) {
			...
			_this.state = {
				userData: _components.Auth.getUserData()
			};
			return _this;
		}
		...
		_createClass(Dashboard, [{
			...
			value: function render() {
				...
				var s = { position: "absolute", width: "100%", height: "100%", top: 0, bottom: 0, left: 0, right: 0 };
				return _react2.default.createElement(
					'div',
					{ style: s },
					!this.props.params.id && _react2.default.createElement(_components.UserTop, { isUpload: true, userData: userData }),
					this.props.children,
					_react2.default.createElement(_components.TabBar, null),
					this.props.isFetching && _react2.default.createElement(_components.Loading, { text: '\u6570\u636E\u6B63\u5728\u52A0\u8F7D\u8BF7\u7A0D\u7B49\u3002\u3002\u3002' })
				);
			}
		}]);
